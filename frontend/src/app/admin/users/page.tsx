...
import { Download, Plus, Loader2, Search, Filter } from "lucide-react"
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-3xl font-extrabold tracking-tight text-slate-900 mb-1">Data Responden</h1>
          <p className="text-slate-500 font-medium">Kelola partisipan dan pantau penyelesaian asesmen stres karyawan.</p>
        </div>
      ...
      <Card className="border border-slate-200/60 shadow-xl shadow-slate-200/40 rounded-3xl bg-white overflow-hidden">
        <div className="p-6 md:p-8 border-b border-slate-100 flex flex-col md:flex-row justify-between items-center gap-4 bg-slate-50/30">
           <div>
              ...
              <CardDescription className="text-slate-500 font-medium mt-1">Total {users.length} responden terdaftar dalam periode ini.</CardDescription>
           </div>
